...
import x.analysis.programPattern.parsingAction.*;
...
public class ParsingTable
{
    ...
    private void mkTestGrammarConflict()
    {
        ...
        PPTerminal plus=new PPTerminal(p);
        PPTerminal mult=new PPTerminal(m);
        PPTerminal id=new PPTerminal(i);
        PPTerminal lpar=new PPTerminal(l);
        PPTerminal rpar=new PPTerminal(r);
        Production e1=new Production(new PPNonTerminal("E"));
        Production e2=new Production(new PPNonTerminal("E"));
        Production e3=new Production(new PPNonTerminal("E"));
        Production e4=new Production(new PPNonTerminal("E"));

        grammar=new Cfg();

        e1.appendToBody(new PPNonTerminal("E"));
        e1.appendToBody(plus);
        e1.appendToBody(new PPNonTerminal("E"));

        e2.appendToBody(new PPNonTerminal("E"));
        e2.appendToBody(mult);
        e2.appendToBody(new PPNonTerminal("E"));

        e3.appendToBody(lpar);
        e3.appendToBody(new PPNonTerminal("E"));
    ...
    private void mkTestGrammar()
    {
        ...
        PPTerminal rpar=new PPTerminal(r);
        Production e1=new Production(new PPNonTerminal("E"));
        Production t1=new Production(new PPNonTerminal("T"));
        Production f1=new Production(new PPNonTerminal("F"));
        Production e2=new Production(new PPNonTerminal("E"));
        Production t2=new Production(new PPNonTerminal("T"));
        Production f2=new Production(new PPNonTerminal("F"));

        grammar=new Cfg();

        e1.appendToBody(new PPNonTerminal("E"));
        e1.appendToBody(plus);
        e1.appendToBody(new PPNonTerminal("T"));

        e2.appendToBody(new PPNonTerminal("T"));

        t1.appendToBody(new PPNonTerminal("T"));
        t1.appendToBody(mult);
        t1.appendToBody(new PPNonTerminal("F"));

        t2.appendToBody(new PPNonTerminal("F"));

        f1.appendToBody(lpar);
        f1.appendToBody(new PPNonTerminal("E"));
        f1.appendToBody(rpar);

        f2.appendToBody(id);

        grammar.addProduction(e1);
        grammar.addProduction(t1);
        grammar.addProduction(f1);
        grammar.addProduction(e2);
        grammar.addProduction(t2);
        grammar.addProduction(f2);
